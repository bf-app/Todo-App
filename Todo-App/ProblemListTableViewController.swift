//
//  ProblemListTableViewController.swift
//  Todo-App
//
...
class ProblemListTableViewController: UITableViewController {
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        self.navigationItem.rightBarButtonItem = UIBarButtonItem(title: "新規作成", style: UIBarButtonItemStyle.Plain, target: self, action: #selector(ProblemListTableViewController.newTodo))
    ...
    func newTodo() {
        self.performSegueWithIdentifier("PresentNewProblemViewController", sender: self)
    }
    ...
    override func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return self.todoCollection.problemList.count
    }

    
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = UITableViewCell(style: UITableViewCellStyle.Subtitle, reuseIdentifier: "problemIdentifier")
        let todo = self.todoCollection.problemList[indexPath.row]
