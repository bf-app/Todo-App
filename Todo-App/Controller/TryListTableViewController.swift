...
class TryListTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        todoCollection.fetchTodos("tryList")
    }
    ...
    override func tableView(tableView: UITableView, commitEditingStyle editingStyle: UITableViewCellEditingStyle, forRowAtIndexPath indexPath: NSIndexPath) {
        switch editingStyle {
        case .Delete:
            self.todoCollection.tryList.removeAtIndex(indexPath.row)
            self.todoCollection.save("tryList")
    ...
    override func tableView(tableView: UITableView, moveRowAtIndexPath sourceIndexPath: NSIndexPath, toIndexPath destinationIndexPath: NSIndexPath) {
        let todo = self.todoCollection.tryList[sourceIndexPath.row]
        self.todoCollection.tryList.removeAtIndex(sourceIndexPath.row)
        self.todoCollection.tryList.insert(todo, atIndex: destinationIndexPath.row)
        self.todoCollection.save("tryList")
    }
